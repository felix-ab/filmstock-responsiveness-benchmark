...
def build_doc() -> None:
    ...
    add_para(doc, "These factors were chosen because they are familiar in photographic practice and measurable with image features. A photographer, colorist, or art director could use this language to describe the desired behavior of an image, and each factor has an expected visual direction that can be evaluated through color, tone, texture, and covariance features.")
