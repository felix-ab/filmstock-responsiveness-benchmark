...
def build_doc() -> None:
    ...
    add_para(doc, "The useful thing about these factors is that they sit at the overlap between creative practice and statistical measurement. A photographer, colorist, or art director could realistically use this language to describe the desired behavior of an image, and each factor also has a concrete expected visual direction that can be evaluated through color, tone, texture, and covariance features.")
